...
<div class="flip-card" class:flipCardTwist style="--mv: {mv};">
  <div class="flip-card-inner">
    <div
      class={"flip-card-front " + cardType}
      on:click={() => (flipCardTwist = true)}
    >
      <div class="content">
    ...
    <div
      class={"flip-card-back " + cardType}
      on:click={() => (flipCardTwist = false)}
      id="frame"
    >
      <div class="modal">
...
<style>
  * {
  ...
  .flipCardTwist .flip-card-inner {
    ...
    transform: translate(var(--card-w), calc(var(--card-w) * -1))
      rotateY(180deg) scale(calc(3), calc(3)) translateZ(+1px);
  }
